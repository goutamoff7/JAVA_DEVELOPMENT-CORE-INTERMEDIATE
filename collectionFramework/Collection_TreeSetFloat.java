...
class Collection_TreeSetFloat {
	public static void main(String[] args) {
		...
		ts1.add(100.5f); // adding float in ts1
		ts1.add(50.6f); // adding floatin ts1
		ts1.add(150.8f); // adding float in ts1
		ts1.add(25.3f); // adding floatin ts1
		ts1.add(75.5f); // adding floatin ts1
		ts1.add(125.9f); // adding float in ts1
		ts1.add(175.4f); // adding float in ts1
		...
		ts2.add(150.8f);// Duplicate value if entered will not be included in TreeSet.
		System.out.println(ts2);
		System.out.println(ts2.contains(100.5f));// searching the value in the TreeSet
		System.out.println(ts2.contains(200.0f));// if contains then return true else return false

		System.out.println("higher of 50 : " + ts2.higher(50.6f));
		System.out.println("lower of 50 : " + ts2.lower(50.6f));

		System.out.println("ceiling of 50 : " + ts2.ceiling(50.6f));
		System.out.println("floor of 50 : " + ts2.floor(50.6f));

		System.out.println("higher of 40 : " + ts2.higher(40.0f));
		System.out.println("lower of 40 : " + ts2.lower(40.0f));

		System.out.println("ceiling of 40 : " + ts2.ceiling(40.0f));
		System.out.println("floor of 40 : " + ts2.floor(40.0f));
