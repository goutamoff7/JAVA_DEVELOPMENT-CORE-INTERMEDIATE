...
class Collection_TreeSetChar {
	public static void main(String[] args) {
		TreeSet ts1 = new TreeSet();
		ts1.add('C'); // adding char in ts1
		ts1.add('G'); // adding char in ts1
		ts1.add('A'); // adding char in ts1
		ts1.add('H'); // adding char in ts1
		ts1.add('F'); // adding char in ts1
		ts1.add('E'); // adding char in ts1
		ts1.add('D'); // adding char in ts1
		...
		ts2.add('A');// Duplicate value if entered will not be included in TreeSet.
		System.out.println(ts2);
		System.out.println(ts2.contains('A'));// searching the value in the TreeSet
