...
@StudentDetails (college="Sanaka")   // Annotation used TYPE: interface 
interface CustomAnnotation
{

}

@StudentDetails (college="Sanaka")// Annotation used in ANNOTATION_TYPE : annotation interface
...
@interface TestAnnotation  // Marker Annotation
{ } 
...
//Applying annotation @TestAnnotation2
@TestAnnotation2
class A{}

//Applying annotation @StudentDetails
@StudentDetails (college="Sanaka") // Annotation used in TYPE : class 
class Goutam // Multi-Valued Annotation
{
